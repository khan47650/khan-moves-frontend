...
export default function StepItemSelectionPallets({ items, onChange, error, serviceType }) {
        ...
        <div className="bg-[#F9F8F6] -mx-4 px-4 py-4">
            <div className="max-w-7xl mx-auto mb-3">
                <h3 className="text-xl md:text-2xl font-bold text-[#1a1a1a]">
                    How many pallets are you moving?
                </h3>
                <p className="text-gray-500 text-xs mt-0.5">
                    Search or choose a category, then set the quantity.
                </p>
            </div>
                    ...
                    >
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder="Search for pallet type"
                            ...
                            <div className="relative z-40 mt-2 max-h-72 overflow-y-auto rounded-lg border border-gray-200 bg-white shadow-xl">
                                {searchResults.length > 0 ? (
                                    ...
                                    <p className="px-4 py-8 text-center text-sm text-gray-400">
                                        No pallets found for “{searchQuery}”
                                    </p>
                                )}
                            </div>
                        )}
                        ...
                        {!searchQuery && (
                            <>
                                <p className="mt-6 mb-3 text-sm text-gray-700">
                                    Or quickly add from our pallet categories below:
                                </p>
                                ...
                                {loading ? (
                                    ...
                                    <div className="py-10 text-center">
                                        ...
                                        <p className="text-sm text-gray-400">
                                            No pallet categories available.
                                        </p>
                                    </div>
                                )}
                            </>
                        ...
                        <p className="mt-6 text-center text-xs text-gray-400">
                            Final dimensions and weight will be confirmed before pickup.
                        </p>
                    </div>
                </div>
