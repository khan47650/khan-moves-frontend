...
import {
    FiChevronDown, FiMinus, FiPackage, FiPlus, FiSearch, FiX
} from "react-icons/fi";
...
export default function StepItemSelectionFurniture({
    ...
    const getCount = item => {
        return items.find(selected => sameItem(selected, item))?.quantity || 0;
    };
        ...
        <div className="bg-[#F9F8F6] -mx-4 px-4 py-4">
            <div className="max-w-7xl mx-auto mb-3">
                ...
                <p className="text-gray-500 text-xs mt-0.5">
                    Search or quickly add items from a category.
                </p>
            </div>
                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder="Search for your item(s) e.g. Sofa"
                                        ...
                                        {categories.map(category => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    {isOpen && (
                                                        <div className="relative z-30 mt-2 overflow-hidden rounded-md border border-gray-200 bg-white shadow-xl sm:absolute sm:left-0 sm:top-full sm:mt-2 sm:w-full sm:min-w-70">
                    ...
                    <div className="sticky top-20 w-full flex">
                        ...
                        >
                            ...
                            {items.length > 0 ? (
                                ...
                                <p className="text-sm text-gray-400">
                                    Nothing here yet. Select items from a category.
                                </p>
                            )}
                        </div>
                    </div>
                        ...
                        <div className="space-y-3">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Piano, Treadmill"
                                    className="w-full rounded-lg border border-gray-200 px-3.5 py-2.5 text-sm outline-none focus:border-gray-400"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-4 gap-2">
                                    <input
                                        ...
                                        className="rounded-lg border border-gray-200 px-2 py-2 text-center text-sm outline-none focus:border-gray-400"
                                    />
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 rounded-lg border border-gray-200 px-3.5 py-2 text-sm outline-none focus:border-gray-400"
                                    />

                                    <select
                                        value={custom.weightUnit}
                                        onChange={e => setCustom(prev => ({
                                            ...prev,
