...
export default function DeleteDriverModal({ driver, onCancel, onConfirm, loading }) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden">
                <div className="px-6 py-6 text-center">
                    ...
                    <h3 className="font-bold text-gray-900 text-lg mb-1">Remove Driver?</h3>
                    ...
                    <p className="text-xs text-[#C0392B] font-medium bg-red-50 rounded-xl px-4 py-2.5 mt-3">
                        ⚠️ Their profile photo and licence will also be permanently deleted.
                    </p>
                </div>
